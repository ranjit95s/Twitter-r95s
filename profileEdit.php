...
<html>
<head>
<title><?php echo '(@'. $user->username .')';?> edit page</title>
	<meta charset="UTF-8" />
...
<div class="profile-nav">
	<div class="profile-navigation">
		<ul>
			...
			<li>
				<a href="<?php BASE_URL.$user->username.'/followers';?>">
					<div class="n-head">
						FOLLOWERS
					</div>
					<div class="n-bottom">
							...
							<div class="t-s-f-right">
								<ul> 
									...
									'.(($tweet->tweetBy === $user_id) ? '
											...
											<ul> 
											<li><label class="deleteTweet" data-tweet="'.$tweet->tweetID.'">Delete Tweet</label>
											</li>
											</ul>
									</li>' : '').'
								</ul>

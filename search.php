...
if (isset($_GET['search']) && !empty($_GET['search'])) {
	$hashtag = $getFromU->checkInput($_GET['search']);
	$user_id = @$_SESSION['user_id'];
	$user     = $getFromU->userData($user_id);
	$tf = $getFromT->searchTCount($hashtag);
	$resultTweets = $getFromT->searchTweets($hashtag);
	$tweetsLatests = $getFromT->searchTweetsLeasted($hashtag);
							...
							<div class="hash-menu" >
								<div class="hash-menu-inner">
									<ul>
												...
												?>
										<li class="<?php active($hashtag);?>"><a href="<?php echo BASE_URL . 'search/' . $hashtag; ?>">Top</a></li>
										<li class="<?php active($hashtag.'&f=latest');?>"><a href="<?php echo BASE_URL . 'search/' . $hashtag . '&f=latest'; ?>">Latest</a></li>
										<li class="<?php active($hashtag.'&f=users');?>"><a href="<?php echo BASE_URL . 'search/' . $hashtag . '&f=users'; ?>">Accounts</a></li>
										<li class="<?php active($hashtag.'&f=photos');?>"><a href="<?php echo BASE_URL . 'search/' . $hashtag . '&f=photos'; ?>">Photos</a></li>
									</ul>
								</div>
							</div>
						</section>
...
<div class="clear_fix" style="display:none; height:55px; width:100%;"></div>
    ...
    margin-top: 50px;
    font-size: 2rem;
    font-weight: 500;"> Nothing to show on <span style="    margin: 0;
    /* display: flex; */
    font-weight: 800;
    color: #499bea;"><?php echo $hashtag; ?></span> </h4>
									<div class="clear_fix" style="display:none; height:55px; width:100%;"></div>
								</div>
							</div>
							<!-- TWEETS ACCOUNTS -->

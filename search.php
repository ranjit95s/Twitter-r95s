						...
						<section class="hash-hash-nav">
							<div class="hash-menu" >
								<div class="hash-menu-inner">
									<ul>
										<li><a href="<?php echo BASE_URL . 'search/' . $hashtag; ?>">Top</a></li>
										<li><a href="<?php echo BASE_URL . 'search/' . $hashtag . '&f=latest'; ?>">Latest</a></li>
										<li><a href="<?php echo BASE_URL . 'search/' . $hashtag . '&f=users'; ?>">Accounts</a></li>
										<li><a href="<?php echo BASE_URL . 'search/' . $hashtag . '&f=photos'; ?>">Photos</a></li>
									</ul>
								</div>
							</div>
						</section>
